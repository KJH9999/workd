...
<body>
	...
	<h1 style="text-align: center;">등록하기</h1>
	<%
	...
	<form action="registOk" method="get">
		<div class="select">
			...
			<input type="hidden" name="pay" value="0"> <input
				...
				onclick=onClickRadio(150000) value="3"><label for="select2">3개월<br />15만원
			</label> <input type="radio" id="select3" name="slct"
				onclick=onClickRadio(250000) value="6"><label for="select3">6개월<br />25만원
			</label> <input type="radio" id="select4" name="slct"
				onclick=onClickRadio(360000) value="12"><label for="select4">12개월<br />36만원
