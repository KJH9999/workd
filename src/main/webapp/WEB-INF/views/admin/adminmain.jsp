									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												...
												월 등록 수익</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800">3,000,000원</div>
										</div>
										<div class="col-auto">
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												...
												회원 수</div>
											<div class="h5 mb-0 font-weight-bold text-gray-800">300명</div>
										</div>
										<div class="col-auto">
							...
							<div class="card border-left-info shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-info text-uppercase mb-1">환불
											</div>
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
													<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">10명</div>
												</div>
							...
							<div class="col-xl-8 col-lg-7">
								<div class="card shadow mb-4">
									...
									<div
										...
										<h6 class="m-0 font-weight-bold text-primary">수익</h6>
